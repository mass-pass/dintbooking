...
box-shadow: inset 0px 0px 0px 0.25em black;
    ...
    <div class="" style="padding-left: 20%;padding-top:5%;">
        <div id="name-and-location" class="">
            <div class="place-section">
                <div class="row">
                    ...
                    <div >
                        ...
                        <form id="propertyDetailsForm" style="display:none" method="POST" action="{{route('property.details.photo',$property->id)}}">
                            @csrf
                            ...
                            <div class="btn-section-artment mt-2">
                                <a href="{{route('property.details.rule',$property->id)}}" class="thme-btn-border mr-3"><i class="fas fa-chevron-left"></i></a>
