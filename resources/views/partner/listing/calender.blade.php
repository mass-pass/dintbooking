    ...
    <div class="row">
      <div class="col-md-9">
        <div class="box box-info">
          <div class="box-body">
            <div class="modal fade d-none z-index-high" id="hotel_date_package" role="dialog">
              ...
              <form method='post' action="property-save/{{$result->id}}/pricing">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-6 col-xs-6 text-left mt-30">
                    <a data-prevent-default="" href="{{ url('partner/listing/'.$result->id.'/booking') }}" class="btn btn-large btn-primary">{{trans('messages.listing_description.back')}}</a>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-6 text-right mt-30">
                    <a data-prevent-default="" href="{{ url('partner/properties') }}" class="btn btn-large btn-primary">{{trans('messages.listing_calendar.your_list')}}</a>
                  </div>
                </div>
              </form>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 mt-30">
                  <a class="js-calendar-sync text-muted btn btn-primary" data-prevent-default="true" href="{{ url('partner/icalendar/synchronization/'.$result->id) }}">Sync with other calendars</a>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 mt-30">
