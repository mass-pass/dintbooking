...
@section('main')
    <div class="aparment-section">
        <div class="container">
            <h3>How many {{$property_type}}s are you listing? </h3>
            <div class="row">
                <div class="col-lg-5">
                    <form id="ownTypeForm" action="{{route('partner.property.confirmOwnType')}}">
                        ...
                        <div class="aparment-section-inner">
                            <div class="aprtment-details">
                                <input type="radio" name="property_count" value="one">
                                <div class="d-flex aparment-checkbox align-items-center">
                                    <img src="{{asset('images/property-type-category/'.$property_type.'.png')}}">
                                    <p>One {{$property_type}}</p>
                                </div>
                            </div>
                            <div class="aprtment-details">
                                <input type="radio" name="property_count" value="multiple">
                                <div class="d-flex aparment-checkbox align-items-center">
                                    <img src="{{asset('images/property-type-category/'.$property_type.'.png')}}">
                                    <p>Multiple {{$property_type}}s</p>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#ownTypeForm').submit(function(e){
                ...
                if(selectedRadio === "multiple" && total_number_of_properties < 2){
