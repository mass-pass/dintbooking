            ...
            <div class="place-section">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <hr class="mt-4">
                        <form id="propertyDetailsForm" method="POST" action="{{route('partner.property.details.availability',$property->id)}}">
                            @csrf
                        <div class="btn-section-artment">
                            <a href="{{route('partner.property.details.ratePlans',$property->id)}}" class="thme-btn-border mr-3"><i class="fas fa-chevron-left"></i></a>
